...
# Ajouter une pyramide avec une base carrée et quatre faces latérales
bpy.ops.mesh.primitive_cone_add(vertices=4, radius1=1, radius2=0, depth=2, location=(0, 0, 0))
pyramide = bpy.context.view_layer.objects.active
pyramide.name = "Pyramide_Carree"

# Lissage de la pyramide pour éviter les facettes visibles
...
# Assigner le matériau à la pyramide
pyramide.data.materials.append(material)

# Ajouter une lumière à l'intérieur de la pyramide pour simuler la lumière réfléchie infinie
...
# Pointer la caméra vers la pyramide
...
# Ajouter une lumière interne visible à l'intérieur de la pyramide
bpy.ops.object.light_add(type='POINT', location=(0, 0, 0))
