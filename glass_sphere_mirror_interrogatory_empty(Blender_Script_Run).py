...
# Créer une sphère UV pour représenter le miroir interrogatoire en verre
bpy.ops.mesh.primitive_uv_sphere_add(radius=1, location=(0, 0, 0))
sphere = bpy.context.view_layer.objects.active
sphere.name = "Miroir_Interrogatoire"

# Lissage de la sphère pour éviter les facettes visibles
...
# Ajouter une lumière à l'intérieur de la sphère pour simuler la lumière réfléchie infinie
...
# Pointer la caméra vers la sphère
...
# Ajouter une lumière interne visible à l'intérieur de la sphère
bpy.ops.object.light_add(type='POINT', location=(0, 0, 0))
