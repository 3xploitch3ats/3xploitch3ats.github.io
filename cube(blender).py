...
# Créer un cube pour représenter le miroir interrogatoire en verre
bpy.ops.mesh.primitive_cube_add(size=2, location=(0, 0, 0))
cube = bpy.context.view_layer.objects.active
cube.name = "Miroir_Interrogatoire_Cube"

# Lissage du cube pour éviter les facettes visibles (même si ce n'est généralement pas nécessaire pour un cube)
...
# Ajouter une lumière à l'intérieur du cube pour simuler la lumière réfléchie infinie
...
# Ajouter une lumière interne visible à l'intérieur du cube
bpy.ops.object.light_add(type='POINT', location=(0, 0, 0))
